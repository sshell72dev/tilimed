...
<html lang="ru">
	<head>
		...
		<title>Страница пароля</title><!-- Styles Section  -->
		<link rel="preconnect" href="https://fonts.googleapis.com">
		<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
		<link href="https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&amp;display=swap" rel="stylesheet">
		<link rel="stylesheet" href="<?=$get_template_directory_uri?>/template-tilimed/css/main.css?v=1711572609213">
	</head>
	<body>
								...
								<div class="col-12 col-xl-6">
									<form class="auth-form auth-col" action="/">
										<div class="auth-form__header">
											...
											<p class="auth-form__subtitle">Ваш аккаунт зарегистрирован на почту hello@example.c. Введите пароль, указанный при регистрации</p>
										</div>
										...
										</div><a class="auth-form__link" href="forgot.html">Забыл пароль</a>
									</form>
								</div>
								<div class="col-12 col-xl-6">
		...
		<script src="<?=$get_template_directory_uri?>/template-tilimed/js/vendor.js?v=1711572609213"></script>
		<script src="<?=$get_template_directory_uri?>/template-tilimed/js/main.js?v=1711572609213"></script>
	</body>
</html>