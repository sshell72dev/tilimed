...
<html lang="ru">
	<head>
		...
		<link rel="stylesheet" href="<?=$get_template_directory_uri?>/template-tilimed/css/main.css?v=1711572605976">
	</head>
	<body>
				...
				<section class="analyzes">
					<div class="container">
						...
						<div class="analyzes-search section">
							<div class="row gy-5">
								<div class="col-12 col-lg-8 order-1 order-lg-0 analyzes-search__col">
									<div class="row">
		...
		<script src="<?=$get_template_directory_uri?>/template-tilimed/js/vendor.js?v=1711572605976"></script>
		<script src="<?=$get_template_directory_uri?>/template-tilimed/js/main.js?v=1711572605976"></script>
	</body>
</html>